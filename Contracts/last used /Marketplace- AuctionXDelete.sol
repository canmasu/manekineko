 ...
 */
  ...
  event AuctionCreated(uint64 auctionId, uint256 tokenId, IERC20 paymentToken, uint256 startingPrice, uint256 endingPrice, uint256 duration);
  ...
  //function() external {}
   ...
   function createAuction(uint256 _tokenId, IERC20 _paymentToken, uint256 _startingPrice, uint256 _endingPrice, uint256 _duration) public {
