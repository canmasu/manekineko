...
//    - List for Bidding
//    - Min Bid (optional)
//    - Buyer place Bid, New Bid replace old bid and the coins goto to old bidder
//    - Time up, no more bid
//    - Seller Decide Accept / withdraw
//    --- Accept > Coins goto Seller and Platfrom, NFT goto Buyer
//    --- Withdraw > Coin goto Buyer , NFT goto Seller
// 2. Transaction Fee (3%) Able to set
