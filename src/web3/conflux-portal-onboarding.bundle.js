var ConfluxPortalOnboarding = (function () {
    ...
    const EXTENSION_DOWNLOAD_URL = {
      CHROME: 'https://chrome.google.com/webstore/detail/confluxportal/bjiiiblnpkonoiegdlifcciokocjbhkd',
      FIREFOX: 'https://chrome.google.com/webstore/detail/confluxportal/bjiiiblnpkonoiegdlifcciokocjbhkd',
      DEFAULT: 'https://chrome.google.com/webstore/detail/confluxportal/bjiiiblnpkonoiegdlifcciokocjbhkd',
    };
    ...
    class Onboarding {
       ...
       */
      constructor ({ forwarderOrigin = 'https://portal.confluxnetwork.org/', forwarderMode = FORWARDER_MODE.INJECT } = {}) {
      ...
      _openForwarder () {
        if (this.forwarderMode === FORWARDER_MODE.OPEN_TAB) {
          window.open(this.forwarderOrigin);
        } else {
          Onboarding._injectForwarder(this.forwarderOrigin);
        }
      }
