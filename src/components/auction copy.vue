...
<template>
    ...
    border-radius: 10px 10px 0 0;">{{NFT.description}}</div>
        ...
        <el-card  class="auction_detail" style="width: 500px; height:400px;">  
            <div style="color:white; font-size:1.2em; padding-bottom:10px;"> Auction End {{countdown}} </div>
            <div class="chart-frame" >
                ...
                <div class="chart-right">
                    <div class="chart-current-price" :style="{ 'margin-top' : (lineChart.y_axis-5) + 'px', 'margin-left' : (lineChart.x_axis + 20 ) + 'px' }">{{NFT.paymentTokenSymbol}} {{ parseInt(NFT.currentPrice/(10**18))}} </div>
