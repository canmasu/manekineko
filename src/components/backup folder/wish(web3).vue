...
//connect Collectibles Contract 
const contract_collectibles =  'cfxtest:acbz06p71gzn1e00c3j06gwgnebvgdw1cj50pg1teh';
//const contract_collectibles_addr = 'cfxtest:acbz06p71gzn1e00c3j06gwgnebvgdw1cj50pg1teh';
//connect Exchange Contract
const contract_payment = 'cfxtest:ace4szmrknum7e9m0ykjy9ghhgpkygy48paem6zevb';
//connect Neko Contract
//const contract_neko = 'cfxtest:acfc7ss6kzp1cga5f342wa9r8m71bkxczpfrapgn9d';
...
export default {
  ...
  mounted() {
      if (typeof web3 !== 'undefined') {
        ...
        console.log('Conflux is installed!');

        getWeb3().then((res) => {
            this.web3 = res;
            console.log("wallet CFX :", this.web3);
            console.log('web3 :', this.web3);
            //connect Contracts Collectibles, Payment and Neko
            this.contract.collectibles = new this.web3.Contract({abi:abi_collectible, address:'cfxtest:acbz06p71gzn1e00c3j06gwgnebvgdw1cj50pg1teh'});
            this.contract.payment = new this.web3.Contract({abi:abi_payment, address:'cfxtest:ace4szmrknum7e9m0ykjy9ghhgpkygy48paem6zevb'});
            this.contract.neko = new this.web3.Contract({abi:abi_neko, address:'cfxtest:acfc7ss6kzp1cga5f342wa9r8m71bkxczpfrapgn9d'});
  ...
  methods:{
    async connectWallet(){
     //get current signed wallet address
        await this.web3.conflux.send("cfx_requestAccounts").then((accounts) => {
...
// Retrieve General Information
    getNeko(){
        this.contract.neko.balanceOf(contract_collectibles).call().then((res) => {
