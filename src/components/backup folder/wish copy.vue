    ...
    <div class="mint_container">
        ...
        <el-form :model="form"  v-if="display.isGuardian" :rules="wishRules" ref="guardianForm">
            ...
            <el-form-item class="dialog-footer">
                ...
                <el-button type="primary" @click="onClickConnect()">Connect Wallet</el-button>
            </el-form-item>
  ...
  methods:{
    ...
    if (typeof window.conflux !== "undefined"){
        ...
        try {
            ...
            const account = accounts[0]
            console.log('Connect Accounts :', account);
...
/** 
            ...
            await conflux.sendTransaction('cfx_requestAccounts').then((accounts) => {
            
                console.log('Connect Accounts :', accounts);



                conflux.getBalance(accounts[0]).then((bal) => {
                    console.log('ABC Bal :', bal.toString());
                });
...
/** 
        ...
        const abc = await window.conflux.enable();
        console.log('ABC Account :', abc);
